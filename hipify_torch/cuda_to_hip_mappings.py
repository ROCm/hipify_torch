...
CUDA_SPECIAL_MAP = collections.OrderedDict(
    [
        ...
        ("cusparseSgthr", ("hisparseSgthr", CONV_MATH_FUNC, API_SPECIAL)),
        ("cusparseDgthr", ("hisparseDgthr", CONV_MATH_FUNC, API_SPECIAL)),
        ("cusparseCgthr", ("hisparseCgthr", CONV_MATH_FUNC, API_SPECIAL)),
        ("cusparseZgthr", ("hisparseZgthr", CONV_MATH_FUNC, API_SPECIAL)),
